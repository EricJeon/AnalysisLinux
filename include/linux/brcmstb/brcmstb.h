...
#define BRCM_MAC_TYPE_ETH	0
#define BRCM_MAC_TYPE_MOCA	1
#define BRCM_MAC_TYPE_WIFI	2
#define BRCM_MAC_TYPE_RESERV	3
#define BRCM_MAC_TYPE_MAX	4

extern u8 brcm_primary_macaddr[BRCM_MAC_TYPE_MAX][IFHWADDRLEN];
