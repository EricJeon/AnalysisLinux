...
/* GFr: struct to collect error statistics */
struct ata_err_stats {
    /* all errors */
    unsigned all_errors;

    /* corresponds to fields in enum above */
    unsigned device_errors;
    unsigned hsm_errors;
    unsigned timeout_errors;
    unsigned media_errors;
    unsigned ata_bus_errors;
    unsigned host_bus_errors;
    unsigned system_errors;
    unsigned inv_arg_errors;
    unsigned other_errors;
    unsigned nodev_hints;
    unsigned ncq_errors;

    /* number the speed has been adjusted */
    unsigned speed_limit_adjust;

    /* current speed and mode */
    unsigned cur_speed;
    unsigned cur_mode;
};

/* GFr: error statistic counter */
extern struct ata_err_stats ata_err_stats;
